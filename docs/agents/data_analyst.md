# Data Analyst Agent ($(@{name=Data Analyst Agent; slug=data_analyst; description=Reads CSV/Excel and creates insights.; agent_type=data; tools_enabled=System.Object[]; prompt=You are a Data Analyst. Read tabular data and compute descriptive statistics.; max_steps=8; timeout_seconds=120}.slug))

## 📖 Overview & Real-World Problem Solved
The **Data Analyst Agent** is an advanced AI entity of type "data".
**Problem it solves:** Modern workflows often require manual intervention for "data" related tasks. Reads CSV/Excel and creates insights. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Data Analyst. Read tabular data and compute descriptive statistics."
...
To use the **Data Analyst Agent** professionally:
