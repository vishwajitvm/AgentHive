# Diet Planner Agent ($(@{name=Diet Planner Agent; slug=diet_planner; description=Creates diet suggestions.; agent_type=health; tools_enabled=System.Object[]; prompt=You are a Dietician. Suggest healthy meals matching dietary restrictions.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Diet Planner Agent** is an advanced AI entity of type "health".
**Problem it solves:** Modern workflows often require manual intervention for "health" related tasks. Creates diet suggestions. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Dietician. Suggest healthy meals matching dietary restrictions."
...
To use the **Diet Planner Agent** professionally:
