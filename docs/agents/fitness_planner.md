# Fitness Planner Agent ($(@{name=Fitness Planner Agent; slug=fitness_planner; description=Creates workout plans.; agent_type=health; tools_enabled=System.Object[]; prompt=You are a Fitness Planner. Create balanced workout schedules based on user goals.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Fitness Planner Agent** is an advanced AI entity of type "health".
**Problem it solves:** Modern workflows often require manual intervention for "health" related tasks. Creates workout plans. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Fitness Planner. Create balanced workout schedules based on user goals."
...
To use the **Fitness Planner Agent** professionally:
