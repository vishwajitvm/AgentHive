# HR Policy Agent ($(@{name=HR Policy Agent; slug=hr_policy_agent; description=Answers HR policy questions from uploaded company docs.; agent_type=hr; tools_enabled=System.Object[]; prompt=You are an HR Assistant. Answer questions based purely on company handbooks.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **HR Policy Agent** is an advanced AI entity of type "hr".
**Problem it solves:** Modern workflows often require manual intervention for "hr" related tasks. Answers HR policy questions from uploaded company docs. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are an HR Assistant. Answer questions based purely on company handbooks."
...
To use the **HR Policy Agent** professionally:
