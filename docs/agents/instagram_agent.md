# Instagram Content Agent ($(@{name=Instagram Content Agent; slug=instagram_agent; description=Creates captions, post ideas, replies, and content plans.; agent_type=instagram; tools_enabled=System.Object[]; prompt=You are an Instagram Content expert. Create catchy captions and reply to comments.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Instagram Content Agent** is an advanced AI entity of type "instagram".
**Problem it solves:** Modern workflows often require manual intervention for "instagram" related tasks. Creates captions, post ideas, replies, and content plans. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are an Instagram Content expert. Create catchy captions and reply to comments."
...
To use the **Instagram Content Agent** professionally:
