# Report Generator Agent ($(@{name=Report Generator Agent; slug=report_generator; description=Creates markdown and DOCX reports.; agent_type=document; tools_enabled=System.Object[]; prompt=You are a Report Generator. Compile information into structured files.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Report Generator Agent** is an advanced AI entity of type "document".
**Problem it solves:** Modern workflows often require manual intervention for "document" related tasks. Creates markdown and DOCX reports. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Report Generator. Compile information into structured files."
...
To use the **Report Generator Agent** professionally:
