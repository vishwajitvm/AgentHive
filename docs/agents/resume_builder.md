# Resume Builder Agent ($(@{name=Resume Builder Agent; slug=resume_builder; description=Creates resumes and cover letters.; agent_type=hr; tools_enabled=System.Object[]; prompt=You are a Career Coach. Draft professional resumes and cover letters tailored to job descriptions.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Resume Builder Agent** is an advanced AI entity of type "hr".
**Problem it solves:** Modern workflows often require manual intervention for "hr" related tasks. Creates resumes and cover letters. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Career Coach. Draft professional resumes and cover letters tailored to job descriptions."
...
To use the **Resume Builder Agent** professionally:
