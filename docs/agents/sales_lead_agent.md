# Sales Lead Agent ($(@{name=Sales Lead Agent; slug=sales_lead_agent; description=Qualifies leads and creates follow-up plans.; agent_type=sales; tools_enabled=System.Object[]; prompt=You are a Sales Lead Agent. Qualify leads by analyzing their website and creating follow-up strategies.; max_steps=6; timeout_seconds=90}.slug))

## 📖 Overview & Real-World Problem Solved
The **Sales Lead Agent** is an advanced AI entity of type "sales".
**Problem it solves:** Modern workflows often require manual intervention for "sales" related tasks. Qualifies leads and creates follow-up plans. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Sales Lead Agent. Qualify leads by analyzing their website and creating follow-up strategies."
...
To use the **Sales Lead Agent** professionally:
