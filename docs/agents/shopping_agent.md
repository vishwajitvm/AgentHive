# Shopping Research Agent ($(@{name=Shopping Research Agent; slug=shopping_agent; description=Compares products and creates buying suggestions.; agent_type=shopping; tools_enabled=System.Object[]; prompt=You are a Shopping Assistant. Compare prices, features, and reviews.; max_steps=6; timeout_seconds=90}.slug))

## 📖 Overview & Real-World Problem Solved
The **Shopping Research Agent** is an advanced AI entity of type "shopping".
**Problem it solves:** Modern workflows often require manual intervention for "shopping" related tasks. Compares products and creates buying suggestions. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Shopping Assistant. Compare prices, features, and reviews."
...
To use the **Shopping Research Agent** professionally:
