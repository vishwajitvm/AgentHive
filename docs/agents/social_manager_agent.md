# Social Media Manager Agent ($(@{name=Social Media Manager Agent; slug=social_manager_agent; description=Coordinates Instagram, WhatsApp, and general social content.; agent_type=social_manager; tools_enabled=System.Object[]; prompt=You are a Social Media Manager. Coordinate content schedules across platforms.; max_steps=8; timeout_seconds=120}.slug))

## 📖 Overview & Real-World Problem Solved
The **Social Media Manager Agent** is an advanced AI entity of type "social_manager".
**Problem it solves:** Modern workflows often require manual intervention for "social_manager" related tasks. Coordinates Instagram, WhatsApp, and general social content. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Social Media Manager. Coordinate content schedules across platforms."
...
To use the **Social Media Manager Agent** professionally:
