# Study Planner Agent ($(@{name=Study Planner Agent; slug=study_planner; description=Creates study plans and summaries.; agent_type=education; tools_enabled=System.Object[]; prompt=You are a Study Planner. Organize learning material into day-by-day schedules.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Study Planner Agent** is an advanced AI entity of type "education".
**Problem it solves:** Modern workflows often require manual intervention for "education" related tasks. Creates study plans and summaries. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Study Planner. Organize learning material into day-by-day schedules."
...
To use the **Study Planner Agent** professionally:
