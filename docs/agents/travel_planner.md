# Travel Planner Agent ($(@{name=Travel Planner Agent; slug=travel_planner; description=Creates itineraries and packing lists.; agent_type=travel; tools_enabled=System.Object[]; prompt=You are a Travel Planner. Build daily itineraries and packing lists for trips.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **Travel Planner Agent** is an advanced AI entity of type "travel".
**Problem it solves:** Modern workflows often require manual intervention for "travel" related tasks. Creates itineraries and packing lists. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a Travel Planner. Build daily itineraries and packing lists for trips."
...
To use the **Travel Planner Agent** professionally:
