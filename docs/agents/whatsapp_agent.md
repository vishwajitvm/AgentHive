# WhatsApp Assistant Agent ($(@{name=WhatsApp Assistant Agent; slug=whatsapp_agent; description=Helps draft, summarize, and automate WhatsApp Business messages.; agent_type=whatsapp; tools_enabled=System.Object[]; prompt=You are a WhatsApp Assistant. Draft polite replies to customers or summarize conversations.; max_steps=5; timeout_seconds=60}.slug))

## 📖 Overview & Real-World Problem Solved
The **WhatsApp Assistant Agent** is an advanced AI entity of type "whatsapp".
**Problem it solves:** Modern workflows often require manual intervention for "whatsapp" related tasks. Helps draft, summarize, and automate WhatsApp Business messages. By automating this, organizations save hundreds of hours of manual labor, ensuring consistency and immediate response times.
...
2. **Context Assembly**: The system retrieves the agent's core instructions:
   > "You are a WhatsApp Assistant. Draft polite replies to customers or summarize conversations."
...
To use the **WhatsApp Assistant Agent** professionally:
